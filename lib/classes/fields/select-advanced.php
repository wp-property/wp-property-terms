        ...
        <div class="taxsdiv">
          <div class="jaxtag">
            <div class="ui-widget clearfix">
              <input type="text" class="wpp-terms-input wpp-terms-term" size="<?php $field_size; ?>" autocomplete="off"
                     value="">
              <input type="button" id="terms-input-auto-<?php echo $wpp_terms_taxonomy_field_counter; ?>"
                     class="button taxadd" value="Add">

              <?php if ($options['type'] == 'select_tree'): ?>
                <div class="clearfix"></div>
                <a tabindex="-1" class="assign-parent button-link">Assign Parent</a>
                <div class="clearfix"></div>
                <input type="text" class="wpp-terms-input wpp-terms-parent hidden" size="<?php $field_size; ?>"
                       autocomplete="off" value="" placeholder="Parent">
              <?php endif; ?>
